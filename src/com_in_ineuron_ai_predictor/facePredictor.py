...
class FacePredictor():
    def __init__(self):
        try:
            ...
            self.model = "C:\pwML\objectDetection\FaceRecogAcademy\src\insightface\models\model-y1-test2\model,0"
            self.threshold = 1.24
            self.det = 0
